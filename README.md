...
| `run_log.txt` / `plan_solve_run_log.txt` | 终端输出的完整日志 |
...
- **Trace 全量落盘**：每轮 deepcopy 一份 `messages`，记录 `input_messages / model_output /
  thought / action / observation / history_after`，供网页逐轮展开复盘。
